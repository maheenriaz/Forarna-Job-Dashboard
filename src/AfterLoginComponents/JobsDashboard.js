             ...
             <br></br><br></br>
              <div className="row">
                   ...
                   <br></br>
                     ...
                     <NavLink to="#" style={{textDecoration:'none',color:'black'}} > <h2 id="comp_details" onClick={()=>{this.new()}} className="txt">Jobs Offered</h2></NavLink>
                     </div>
                                                                 ...
                                                                 <p>City Name</p>
                                                                  <p><span class="glyphicon glyphicon-calendar" ></span>Start Date</p>
                                                                   <p><span class="glyphicon glyphicon-calendar" ></span>End Date</p>
                                                                    <p><span class="glyphicon glyphicon-time" ></span>In Progress</p>
                                                              </div>
                                                            </div>  
                                                             ...
                                                             <p>-First line of detail</p>
                                                              ...
                                                              <img src={browse} style={{width:'90px',height:'70px',borderRadius:'10px',marginTop:'10px'}} />
                                                                 ...
                                                                 <p>City Name</p>
                                                                  <p><span class="glyphicon glyphicon-calendar" ></span>Start Date</p>
                                                                   <p><span class="glyphicon glyphicon-calendar" ></span>End Date</p>
                                                            <p><span class="glyphicon glyphicon-time" ></span>In Progress</p>  </div>
                                                            </div>  
